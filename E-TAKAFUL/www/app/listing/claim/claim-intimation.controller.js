(function() {
    'use strict';
    angular.module('app.routes').controller('claimIntimationCtrl', claimIntimationCtrl);
    claimIntimationCtrl.$inject = ['$state', '$rootScope', 'ApiServices', '$filter', '$ionicModal', '$scope', '$translate', '$timeout', '$ionicScrollDelegate'];

    function claimIntimationCtrl($state, $rootScope, ApiServices, $filter, $ionicModal, $scope, $translate, $timeout, $ionicScrollDelegate) {
        ...
        function intimateClaim(index) {
            ...
            $rootScope.claim.policyEndDate = $rootScope.policy.List[index]['POLICYENDDATE'];
